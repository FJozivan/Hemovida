...
<div class="container mt-4">
    <div class="ml-1 mr-1 mb-3">
        <div class="row" style="background-color: white; border-radius: 5px; box-shadow: 0px 0px 0px 0.4px; padding: 15px;">
            ...
            <div class="text-justify col-lg-8 col-sm-12">
                <span>
                    ...
                    <p>&nbsp&nbsp&nbspOs Hemoces são instituições públicas (ou não) que realizam atividades de hemoterapia e hematologia com o objetivo de fornecer sangue (seus componentes e hemoderivados), aos hospitais que solicitarem, além do atendimento ambulatorial das patologias relacionadas com o sangue.</p>
                    <p>&nbsp&nbsp&nbspOs Hemocentros Públicos podem fornecer sangue aos hospitais privados quando houver necessidade e os Hemocentros Privados podem fornecer sangue aos hospitais da rede pública quando os bancos de sangue da rede pública estiverem com baixo estoque de sangue a ponto de impossibilitar o atendimento aos pacientes com doenças de sangue e os casos emergenciais que necessitam de sangue.</p>
                </span>
            </div>
        ...
        <div class="row mt-2" style="background-color: white; border-radius: 5px; box-shadow: 0px 0px 0px 0.4px; padding: 15px;">
