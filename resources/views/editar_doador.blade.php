	...
	<div class="row">
										...
										<div class="container font">
											...
											<div class="form-group row">
												...
												<div class="col-lg-10 col-sm-10">
													<input type="text" class="form-control {{ $errors->has('nome') ? ' is-invalid' : '' }}" id="nome" name="nome" value="{{ $dados->nome }}">
											...
											<div class="form-group row">
												...
												<div class="col-lg-10 col-sm-10">
													<input type="text" class="form-control {{ $errors->has('sobrenome') ? ' is-invalid' : '' }}" id="sobrenome" name="sobrenome" value="{{ $dados->sobrenome }}">
											...
											<div class="form-group row">
												...
												<div class="col-lg-10 col-sm-10">
													<input type="text" class="form-control {{ $errors->has('cpf') ? ' is-invalid' : '' }}" id="cpf" name="cpf" value="{{ $dados->cpf }}">
											...
											<div class="form-group row">
												...
												<div class="col-lg-10 col-sm-10">
													<input type="date" class="form-control {{ $errors->has('data_nascimento') ? ' is-invalid' : '' }}" id="data_nascimento" name="data_nascimento" value="{{ $dados->data_nascimento }}">
											...
											<div class="form-group row">
												...
												<div class="col-lg-10 col-sm-10">
													<input type="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" id="email" name="email" value="{{ $dados->email }}">
											...
											<div class="form-group row">
												...
												<div class="col-lg-10 col-sm-10">
													<input type="text" class="form-control {{ $errors->has('cep') ? ' is-invalid' : '' }}" id="cep" name="cep" maxlength="9" value="{{ $dados->cep }}">
											...
											<div class="row mb-2">
												...
												<!-- <div class="col-sm-7 form-group row"> -->
													<div class="col-lg-6 col-sm-12">
														<input type="text" class="form-control {{ $errors->has('rua') ? ' is-invalid' : '' }}" id="rua" name="rua" value="{{ $dados->rua }}">
													...
													<div class="row">
														...
														<div class="col-lg-4 col-sm-4">
															<input type="text" class="form-control {{ $errors->has('numero') ? ' is-invalid' : '' }}" id="numero" name="numero" value="{{ $dados->numero }}">
												...
												<div class="row">
													...
													<div class="col-sm-4 form-group row">
														<div class="col-lg-10 col-sm-10">
															<input type="text" class="form-control {{ $errors->has('bairro') ? ' is-invalid' : '' }}" id="bairro" name="bairro" value="{{ $dados->bairro }}">
													...
													<div class="col-sm-6 form-group row">
														...
														<div class="col-lg-9 col-sm-10">
															<input type="text" class="form-control {{ $errors->has('cidade') ? ' is-invalid' : '' }}" id="cidade" name="cidade" value="{{ $dados->cidade }}">
												...
												<div class="form-group row">
													...
													<div class="col-lg-10 col-sm-10">
														<input type="text" class="form-control" id="referencia" name="referencia" value="{{ $dados->referencia }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-10 col-sm-10">
														<select class=" custom-select {{ $errors->has('tipo_sanguineo') ? ' is-invalid' : '' }}" name="tipo_sanguineo" id="mySelect">
		...
		$("#cep").blur(function() {
			...
			if (cep != "") {
				...
				document.getElementById("mySelect").value = "{{ $dados->tipo_sanguineo }}";
